...
namespace GenericMathPlayground
{
    ...
    public class Tokenizer
    {
        ...
        public Tokenizer(ReadOnlySpan<char> text, IFormatProvider? formatProvider)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        public Tokenizer(ReadOnlySpan<char> text, char quoteCharacter, char separator)
        {
            this.text = text.ToArray() ?? Array.Empty<char>();
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        public bool TryGetNextToken(out string token) => TryGetNextToken(false, out token);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        public bool TryGetNextToken(bool allowQuotedToken, out string token) => TryGetNextToken(allowQuotedToken, argumentSeparator, out token);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
        public bool TryGetNextToken(bool allowQuotedToken, char separator, out string token)
        {
            bool success = currentCharacterIndex >= textLength || NextToken(allowQuotedToken, separator);
            token = success ? GetCurrentToken() : string.Empty;
            return success;
        }
