...
public static partial class Operations
{
    ...
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static TResult Slope<T, TResult>(T i, T j) where T : INumber<T> where TResult : struct, IFloatingPoint<TResult> => TResult.Abs(TResult.Create(i)) < TResult.Epsilon ? MathConsts<TResult>.SlopeMax : TResult.Create(j / i);
    ...
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static TResult Slope<T, TResult>(T x1, T y1, T x2, T y2) where T : INumber<T> where TResult : struct, IFloatingPoint<TResult> => (TResult.Abs(TResult.Create(x1 - x2)) < TResult.Epsilon) ? MathConsts<TResult>.SlopeMax : TResult.Create((y2 - y1) / (x2 - x1));
    #endregion Slope
    ...
    /// </acknowledgment>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static T Secant<T>(T value) where T : struct, IFloatingPoint<T>
    ...
    {
        var v when v == T.One => T.Create(MathFloatConsts<T>.Hau),
        var v when v == T.NegativeOne => -T.Create(MathFloatConsts<T>.Hau),
