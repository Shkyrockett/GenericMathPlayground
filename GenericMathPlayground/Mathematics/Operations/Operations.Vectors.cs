...
public static partial class Operations
{
    ...
    /// 
    /// </summary>
    public static readonly string[] VectorComponentNames = new string[] { "i", "j", "k", "l", "m" };

    /// <summary>
    /// 
    /// </summary>
    public static readonly string[] VectorDimentionNames = new string[] { "x", "y", "z", "w", "v" };

    /// <summary>
    /// For a lack of words to define sizes in 4+ dimensions, I'm just going to define them with near synonyms of the others.
    /// </summary>
    public static readonly string[] VectorSizeNames = new string[] { "width", "height", "depth", "breadth", "length" };
    ...
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>A (TResult X, TResult Y)? .</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    ...
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>A (TResult X, TResult Y, TResult Z)? .</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    ...
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>A (TResult X, TResult Y, TResult Z, TResult W)? .</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    ...
    /// </summary>
    /// <param name="value">The value.</param>
    /// <returns>A (TResult X, TResult Y, TResult Z, TResult W, TResult V)? .</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
