...
namespace GenericMathPlayground.Mathematics
{
        ...
        where T : INumber<T>
    {
        ...
        public ValueVector5((T I, T J, T K, T L, T M) tupple) => (I, J, K, L, M) = tupple;
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        public static ValueVector5<T> operator +(ValueVector5<T> left, IVector5<T> right) => new(left.I + right.X, left.J + right.Y, left.K + right.Z, left.L + right.W, left.M + right.V);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static ValueVector5<T> operator -(ValueVector5<T> value) => new(-value.I, -value.J, -value.K, -value.L, -value.M);
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        public static ValueVector5<T> operator *(ValueVector5<T> left, T right) => new(left.I * right, left.J * right, left.K * right, left.L * right, left.M * right);
        #endregion
