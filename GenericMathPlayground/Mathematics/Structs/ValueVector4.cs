...
namespace GenericMathPlayground.Mathematics
{
        ...
        where T : INumber<T>
    {
        ...
        public ValueVector4((T I, T J, T K, T L) tupple) => (I, J, K, L) = tupple;
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        public static ValueVector4<T> operator +(ValueVector4<T> left, IVector4<T> right) => new(left.I + right.X, left.J + right.Y, left.K + right.Z, left.L + right.W);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static ValueVector4<T> operator -(ValueVector4<T> value) => new(-value.I, -value.J, -value.K, -value.L);
        ...
        /// <param name="right"></param>
        /// <returns></returns>
        public static ValueVector4<T> operator *(ValueVector4<T> left, T right) => new(left.I * right, left.J * right, left.K * right, left.L * right);
        #endregion
