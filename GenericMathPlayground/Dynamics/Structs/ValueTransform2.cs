    ...
    where T : INumber<T>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static ValueTransform2<T> Parse(string source, IFormatProvider? formatProvider) => Parse((ReadOnlySpan<char>)source, formatProvider);
    ...
    /// <returns>A ValueTransform2.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static ValueTransform2<T> Parse(ReadOnlySpan<char> source, IFormatProvider? formatProvider) => TryParse(source, formatProvider, out var result) ? result : result;
    ...
    /// <returns>A bool.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool TryParse([NotNullWhen(true)] string? source, IFormatProvider? formatProvider, out ValueTransform2<T> result) => TryParse((ReadOnlySpan<char>)source, formatProvider, out result);
    ...
    /// <returns>A bool.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool TryParse(ReadOnlySpan<char> source, IFormatProvider? formatProvider, out ValueTransform2<T> result)
    {
        ...
        var value = new ValueTransform2<T>(result1, result2, result3, result4, result5, result6);
    ...
    /// <summary>
    /// Creates a human-readable string that represents this <see cref="ValueTransform2{T}" /> struct.
    /// </summary>
    /// <returns>
    ...
    /// <summary>
    /// Creates a string representation of this <see cref="ValueTransform2{T}" /> struct based on the IFormatProvider
