...
partial class AngleControl
{
    ...
    private void InitializeComponent()
    {
        ...
        this.needleControl1 = new NeedleControl();
        ...
        this.needleControl1.ValueChanged += new NeedleControl.ValueChangedEventHandler(this.NeedleControl1_ValueChanged);
        this.needleControl1.ValueCommitted += new NeedleControl.ValueCommittedEventHandler(this.NeedleControl1_ValueCommitted);
        // 
        // AngleControl
        // 
