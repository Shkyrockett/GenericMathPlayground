...
namespace GenericMathPlayground.Framework
{
        ...
        : PropertyDescriptor
    {
        ...
        public ExpandableDictionaryPropertyDescriptor(IDictionary d, object key)
            : base(key?.ToString() ?? string.Empty, null)
        {
            dictionary = d;
        ...
        /// Gets the name.
        /// </summary>
        public override string Name => key?.ToString() ?? string.Empty;
        ...
        /// </summary>
        public override Type PropertyType => dictionary[key]?.GetType() ?? typeof(object);
