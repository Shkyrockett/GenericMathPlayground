...
public struct ValueSize2<T>
    ...
    IComparisonOperators<ValueSize2<T>, IVector2<T>, bool>,
    IEqualityOperators<ValueSize2<T>, IVector2<T>, bool>,
    ...
    where T : INumber<T>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static ValueSize2<T> Parse(string source, IFormatProvider? formatProvider) => Parse((ReadOnlySpan<char>)source, formatProvider);
    ...
    /// <returns>A ValueSize2.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static ValueSize2<T> Parse(ReadOnlySpan<char> source, IFormatProvider? formatProvider) => TryParse(source, formatProvider, out var result) ? result : result;
    ...
    /// <returns>A bool.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool TryParse([NotNullWhen(true)] string? source, IFormatProvider? formatProvider, out ValueSize2<T> result) => TryParse((ReadOnlySpan<char>)source, formatProvider, out result);
    ...
    /// <returns>A bool.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static bool TryParse(ReadOnlySpan<char> source, IFormatProvider? formatProvider, out ValueSize2<T> result)
    {
        ...
        var value = new ValueSize2<T>(result1, result2);
    ...
    /// <summary>
    /// Creates a human-readable string that represents this <see cref="ValueSize2{T}" /> struct.
    /// </summary>
    /// <returns>
    ...
    /// <summary>
    /// Creates a string representation of this <see cref="ValueSize2{T}" /> struct based on the IFormatProvider
