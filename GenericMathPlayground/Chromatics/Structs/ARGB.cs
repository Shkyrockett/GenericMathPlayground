    ...
    where T : INumber<T>
{
    ...
    /// <summary>
    /// Creates a human-readable string that represents this <see cref="ARGB{T}" /> struct.
    /// </summary>
    /// <returns>
    ...
    /// <summary>
    /// Creates a string representation of this <see cref="ARGB{T}" /> struct based on the IFormatProvider
