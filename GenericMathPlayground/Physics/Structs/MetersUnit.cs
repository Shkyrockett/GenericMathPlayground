...
namespace GenericMathPlayground.Physics
{
        ...
        IMinMaxValue<MetersUnit>
    {
        ...
        /// <summary>Represents the smallest positive <see cref="MetersUnit" /> value that is greater than zero. This field is constant.</summary>
        [RequiresPreviewFeatures]
        ...
        /// <summary>Represents the smallest possible value of a <see cref="MetersUnit" />. This field is constant.</summary>
        [RequiresPreviewFeatures]
        public static MetersUnit MinValue => double.MinValue;

        /// <summary>Represents the largest possible value of a <see cref="MetersUnit" />. This field is constant.</summary>
        [RequiresPreviewFeatures]
        ...
        #region Constructors
        public MetersUnit(double v)
            : this() => value = v;
        #endregion

        #region OPerators
        /// <summary>Returns a value that indicates whether two specified <see cref="MetersUnit" /> values are equal.</summary>
        ...
        /// <summary>Returns a value that indicates whether two specified <see cref="MetersUnit" /> values are not equal.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value that indicates whether a specified <see cref="MetersUnit" /> value is greater than another specified <see cref="MetersUnit" /> value.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value that indicates whether a specified <see cref="MetersUnit" /> value is greater than or equal to another specified <see cref="MetersUnit" /> value.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value that indicates whether a specified <see cref="MetersUnit" /> value is less than another specified <see cref="MetersUnit" /> value.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value that indicates whether a specified <see cref="MetersUnit" /> value is less than or equal to another specified <see cref="MetersUnit" /> value.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value indicating whether this instance and a specified <see cref="MetersUnit" /> object represent the same value.</summary>
        ...
        /// <returns>
        ///   <see langword="true" /> if <paramref name="obj" /> is an instance of <see cref="MetersUnit" /> and equals the value of this instance; otherwise, <see langword="false" />.</returns>
        ...
        /// <summary>Returns the <see cref="T:System.TypeCode" /> for value type <see cref="MetersUnit" />.</summary>
        /// <returns>The enumerated constant, <see cref="F:System.TypeCode.MetersUnit" />.</returns>
        ...
        /// <param name="d">A double-precision floating-point number.</param>
        /// <returns>
        ///   <see langword="true" /> if <paramref name="d" /> evaluates to <see cref="F:MetersUnit.PositiveInfinity" /> or <see cref="F:MetersUnit.NegativeInfinity" />; otherwise, <see langword="false" />.</returns>
        public static bool IsInfinity(MetersUnit d) => double.IsInfinity(d.value);

        /// <summary>Returns a value that indicates whether the specified value is not a number (<see cref="F:MetersUnit.NaN" />).</summary>
        /// <param name="d">A double-precision floating-point number.</param>
        /// <returns>
        ///   <see langword="true" /> if <paramref name="d" /> evaluates to <see cref="F:MetersUnit.NaN" />; otherwise, <see langword="false" />.</returns>
        ...
        /// <param name="d">A double-precision floating-point number.</param>
        /// <returns>
        ///   <see langword="true" /> if <paramref name="d" /> evaluates to <see cref="F:MetersUnit.NegativeInfinity" />; otherwise, <see langword="false" />.</returns>
        ...
        /// <param name="d">A double-precision floating-point number.</param>
        /// <returns>
        ///   <see langword="true" /> if <paramref name="d" /> evaluates to <see cref="F:MetersUnit.PositiveInfinity" />; otherwise, <see langword="false" />.</returns>
        ...
        public static TInteger ILogB<TInteger>(MetersUnit x) where TInteger : IBinaryInteger<TInteger> => Operations.Cast<int, TInteger>(Math.ILogB(x.value));
