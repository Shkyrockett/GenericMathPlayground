...
namespace GenericMathPlayground.Physics
{
        ...
        IMinMaxValue<FeetUnit>
    {
        ...
        /// <summary>Represents the smallest positive <see cref="FeetUnit" /> value that is greater than zero. This field is constant.</summary>
        [RequiresPreviewFeatures]
        ...
        /// <summary>Represents the smallest possible value of a <see cref="FeetUnit" />. This field is constant.</summary>
        [RequiresPreviewFeatures]
        public static FeetUnit MinValue => double.MinValue;

        /// <summary>Represents the largest possible value of a <see cref="FeetUnit" />. This field is constant.</summary>
        [RequiresPreviewFeatures]
        ...
        #region Constructors
        public FeetUnit(double v)
            : this() => value = v;
        #endregion

        #region OPerators
        /// <summary>Returns a value that indicates whether two specified <see cref="FeetUnit" /> values are equal.</summary>
        ...
        /// <summary>Returns a value that indicates whether two specified <see cref="FeetUnit" /> values are not equal.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value that indicates whether a specified <see cref="FeetUnit" /> value is greater than another specified <see cref="FeetUnit" /> value.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value that indicates whether a specified <see cref="FeetUnit" /> value is greater than or equal to another specified <see cref="FeetUnit" /> value.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value that indicates whether a specified <see cref="FeetUnit" /> value is less than another specified <see cref="FeetUnit" /> value.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value that indicates whether a specified <see cref="FeetUnit" /> value is less than or equal to another specified <see cref="FeetUnit" /> value.</summary>
        /// <param name="left">The first value to compare.</param>
        /// <param name="right">The second value to compare.</param>
        /// <returns>
        ...
        /// <summary>Returns a value indicating whether this instance and a specified <see cref="FeetUnit" /> object represent the same value.</summary>
        ...
        /// <returns>
        ///   <see langword="true" /> if <paramref name="obj" /> is an instance of <see cref="FeetUnit" /> and equals the value of this instance; otherwise, <see langword="false" />.</returns>
        ...
        /// <summary>Returns the <see cref="T:System.TypeCode" /> for value type <see cref="FeetUnit" />.</summary>
        /// <returns>The enumerated constant, <see cref="F:System.TypeCode.FeetUnit" />.</returns>
        ...
        /// <param name="d">A double-precision floating-point number.</param>
        /// <returns>
        ///   <see langword="true" /> if <paramref name="d" /> evaluates to <see cref="F:FeetUnit.PositiveInfinity" /> or <see cref="F:FeetUnit.NegativeInfinity" />; otherwise, <see langword="false" />.</returns>
        public static bool IsInfinity(FeetUnit d) => double.IsInfinity(d.value);

        /// <summary>Returns a value that indicates whether the specified value is not a number (<see cref="F:FeetUnit.NaN" />).</summary>
        /// <param name="d">A double-precision floating-point number.</param>
        /// <returns>
        ///   <see langword="true" /> if <paramref name="d" /> evaluates to <see cref="F:FeetUnit.NaN" />; otherwise, <see langword="false" />.</returns>
        ...
        /// <param name="d">A double-precision floating-point number.</param>
        /// <returns>
        ///   <see langword="true" /> if <paramref name="d" /> evaluates to <see cref="F:FeetUnit.NegativeInfinity" />; otherwise, <see langword="false" />.</returns>
        ...
        /// <param name="d">A double-precision floating-point number.</param>
        /// <returns>
        ///   <see langword="true" /> if <paramref name="d" /> evaluates to <see cref="F:FeetUnit.PositiveInfinity" />; otherwise, <see langword="false" />.</returns>
        ...
        public static TInteger ILogB<TInteger>(FeetUnit x) where TInteger : IBinaryInteger<TInteger> => Operations.Cast<int, TInteger>(Math.ILogB(x.value));
