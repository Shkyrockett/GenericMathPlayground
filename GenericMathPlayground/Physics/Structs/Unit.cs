    ...
    IMinMaxValue<Unit>
{
    ...
    /// </returns>
    /// <exception cref="FormatException">s does not represent a numeric value.</exception>
    /// <exception cref="ArgumentException">style is not a System.Globalization.NumberStyles value. -or- style is the System.Globalization.NumberStyles.AllowHexSpecifier value.</exception>
    ...
    /// <exception cref="OverflowException">.NET Framework and .NET Core 2.2 and earlier versions only: s represents a number that is less than System.double.MinValue or greater than System.double.MaxValue.</exception>
    ...
    /// <exception cref="FormatException">s does not represent a number in a valid format.</exception>
    /// <exception cref="OverflowException">.NET Framework and .NET Core 2.2 and earlier versions only: s represents a number that is less than System.double.MinValue or greater than System.double.MaxValue.</exception>
    /// <exception cref="ArgumentException">style is not a System.Globalization.NumberStyles value. -or- style includes the System.Globalization.NumberStyles.AllowHexSpecifier value.</exception>
    ...
    /// </returns>
    /// <exception cref="InvalidCastException">In all cases.</exception>
